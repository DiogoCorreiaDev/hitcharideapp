...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                        ...
                                        if (distanceInMiles < 0.01) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callRideButton.setVisibility(View.VISIBLE);
                                                    callRideButton.setText("Hitch a Ride");
                                                    requestActive = false;
                                                    driverActive = false;
                                                }
                                            }, 5000);
                                            ...
                                            callRideButton.setVisibility(View.INVISIBLE);
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    if (e == null) {
                        if (objects.size() > 0) {
                            ...
                            requestActive = false;
                            callRideButton.setText("Call Ride");
                        }
                    }
                }
            });
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callRideButton.setText("Cancel Ride");
                                requestActive=true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callRideButton = findViewById(R.id.callRideButton);
